...
@click.option('--label', help='Assign a label to the newly-created card. Label must be a color name or an id')
@click.option('--is-label-id', is_flag=True, help='The given label will be treated as an id if this option is present')
